...
class Database(object):
    ...
    def query_url_stats(self):
        ...
        sql += ",        AVG(`request_processing_time_sec`) `avg_request_processing_time_sec` "
        ...
        sql += ",        AVG(`target_processing_time_sec`) `avg_target_processing_time_sec` "
        ...
        sql += ",        AVG(`response_processing_time_sec`) `avg_response_processing_time_sec` "
